...
case 'bug': case 'report': {
                    	...
                    	ZarnBot.sendMessage(`62895337447795@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
case 'req': case 'request': {
                    	...
                    	ZarnBot.sendMessage(`62895337447795@s.whatsapp.net`, {text: `*Request Feature From:* wa.me/${m.sender.split("@")[0]}
